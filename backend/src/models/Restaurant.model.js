...
restaurantSchema.methods.isOpenAt = function (date) {
  ...
  if (!hours || hours.isClosed) {
    return { isOpen: false, reason: 'Restaurant is closed at this time.' };
  }
